...
/**
 * The Class AVIInfoHolder.
 * This is a implementation of <code>IFileInfoHolder</code> defined with type <code>AVI_INFO</code> to determine AVI file information.
 * Stores file type, file encoding date.
 * 
 * @author  housekatze
 */
public class AVIInfoHolder  extends AbstractInfoHolder {
    private static Logger log = LoggerFactory.getLogger(AVIInfoHolder.class);
    
	/** The file type. */
	private int   fileType = AVI_FILE;
    ...
    public AVIInfoHolder(String[] nameMask) {
	...
	public void appendFileInfo(IFileInfoHolder infoHolder) {
		if (!infoHolder.getClass().getName().equals(this.getClass().getName())) 
			return;
		AVIInfoHolder holder = (AVIInfoHolder)infoHolder;
