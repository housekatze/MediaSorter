 ...
 * @author  housekatze
 */
public class MKVInfoHolder  extends AbstractInfoHolder {
    private static Logger log = LoggerFactory.getLogger(MKVInfoHolder.class);
    
	/** The file type. */
	private int   fileType = MKV_FILE;
    ...
    public MKVInfoHolder(String[] nameMask) {
	...
	public void appendFileInfo(IFileInfoHolder infoHolder) {
		if (!infoHolder.getClass().getName().equals(this.getClass().getName())) 
			return;
		MKVInfoHolder holder = (MKVInfoHolder)infoHolder;
