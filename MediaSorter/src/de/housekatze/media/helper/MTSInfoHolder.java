 ...
 * @author  housekatze
 */
public class MTSInfoHolder  extends AbstractInfoHolder {
    private static Logger log = LoggerFactory.getLogger(MTSInfoHolder.class);
    
	/** The file type. */
	private int   fileType = MTS_FILE;
    ...
    public MTSInfoHolder(String[] nameMask) {
	...
	public void appendFileInfo(IFileInfoHolder infoHolder) {
		if (!infoHolder.getClass().getName().equals(this.getClass().getName())) 
			return;
		MTSInfoHolder holder = (MTSInfoHolder)infoHolder;
